"""
    ...
    Classes/Functions:
    - TestPythonParser (line 48):
      - bar(x) (line 58)
      - baz(y) (line 61)
      - test_parse_python_file(source: str, expected_classes: list[ClassInfo], expected_funcs: list[SignatureInfo]) -> None (line 109)
      - test_complex_python_structure() -> None (line 115)
      - global_func() (line 118)
      - outer_method(param: str) -> None (line 122)
      - inner_method() (line 126)
      - another_global(x, y=None) (line 129)
    - TestKotlinParser (line 147):
      - test_basic_kotlin_parsing() -> None (line 150)
      - test_kotlin_with_modifiers() -> None (line 172)
    - TestGenericParser (line 191):
      - test_empty_file(language: str) -> None (line 195)
      - test_javascript_parsing() -> None (line 201)
      - test_csharp_parsing() -> None (line 224)
      - test_cpp_parsing() -> None (line 249)
      - test_unsupported_language() -> None (line 268)
    - TestErrorHandling (line 275):
      - test_malformed_python_code() -> None (line 278)
      - test_very_long_lines() -> None (line 293)
    - TestMoreLanguages (line 303):
      - test_c_parsing() (line 306)
      - test_java_parsing() (line 327)
      - test_go_parsing() (line 357)
      - test_powershell_parsing() (line 380)
      - test_delphi_parsing() (line 404)
