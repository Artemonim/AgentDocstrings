"""
    ...
    Classes/Functions:
      - TestPythonASTParser (line 14):
        - test_async_functions(self) -> None (line 15)
        - test_class_with_nested_class(self) -> None (line 24)
        - test_complex_type_annotations(self) -> None (line 46)
        - test_decorators_and_properties(self) -> None (line 58)
        - test_edge_cases(self) -> None (line 73)
        - test_function_with_all_argument_types(self) -> None (line 92)
        - test_malformed_syntax_fallback(self) -> None (line 104)
      - TestGoASTParser (line 117):
        - test_go_interface_parsing(self) -> None (line 118)
        - test_go_methods_on_structs(self) -> None (line 137)
        - test_go_complex_signatures(self) -> None (line 156)
        - test_go_empty_functions(self) -> None (line 187)
