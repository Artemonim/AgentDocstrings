...
"""
    ...
    Classes/Functions:
      - Functions:
        - fixtures_dir() -> Path (line 35)
        - sample_python_file(tmp_path: Path) -> Iterator[Path] (line 41)
        - sample_kotlin_file(tmp_path: Path) -> Iterator[Path] (line 63)
        - sample_javascript_file(tmp_path: Path) -> Iterator[Path] (line 89)
        - sample_typescript_file(tmp_path: Path) -> Iterator[Path] (line 122)
        - sample_csharp_file(tmp_path: Path) -> Iterator[Path] (line 157)
        - sample_cpp_file(tmp_path: Path) -> Iterator[Path] (line 200)
        - complex_python_file(tmp_path: Path) -> Iterator[Path] (line 251)
        - python_file_with_existing_header(tmp_path: Path) -> Iterator[Path] (line 359)
        - multilanguage_project(tmp_path: Path) -> Iterator[Path] (line 392)
        - empty_files_project(tmp_path: Path) -> Iterator[Path] (line 429)
        - sample_files_by_language(tmp_path: Path) -> Iterator[Dict[str, Path]] (line 449)
        - malformed_files_project(tmp_path: Path) -> Iterator[Path] (line 481)
