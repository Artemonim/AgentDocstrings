"""
    ...
    Classes/Functions:
        - source_processor(tmp_path: Path) (line 34)
        - fixtures_dir() -> Path (line 62)
        - sample_python_file(tmp_path: Path) -> Iterator[Path] (line 68)
        - sample_kotlin_file(tmp_path: Path) -> Iterator[Path] (line 90)
        - sample_javascript_file(tmp_path: Path) -> Iterator[Path] (line 116)
        - sample_typescript_file(tmp_path: Path) -> Iterator[Path] (line 149)
        - sample_csharp_file(tmp_path: Path) -> Iterator[Path] (line 184)
        - sample_cpp_file(tmp_path: Path) -> Iterator[Path] (line 227)
        - complex_python_file(tmp_path: Path) -> Iterator[Path] (line 278)
        - python_file_with_existing_header(tmp_path: Path) -> Iterator[Path] (line 386)
        - multilanguage_project(tmp_path: Path) -> Iterator[Path] (line 419)
        - empty_files_project(tmp_path: Path) -> Iterator[Path] (line 456)
        - sample_files_by_language(tmp_path: Path) -> Iterator[Dict[str, Path]] (line 476)
        - malformed_files_project(tmp_path: Path) -> Iterator[Path] (line 508)
...
def python_file_with_existing_header(tmp_path: Path) -> Iterator[Path]:
    ...
    from agent_docstrings.languages.common import DOCSTRING_START_MARKER, DOCSTRING_END_MARKER
