"""
    ...
    Classes/Functions:
      - TestPythonASTIntegration (line 12):
        - test_python_ast_integration_complex(self, tmp_path: Path) -> None (line 13)
        - test_python_ast_integration_async_functions(self, tmp_path: Path) -> None (line 46)
        - test_python_ast_integration_nested_classes(self, tmp_path: Path) -> None (line 72)
      - TestGoASTIntegration (line 105):
        - test_go_ast_integration_interfaces(self, tmp_path: Path) -> None (line 106)
        - test_go_ast_integration_methods(self, tmp_path: Path) -> None (line 148)
        - test_go_ast_fallback_integration(self, tmp_path: Path) -> None (line 186)
